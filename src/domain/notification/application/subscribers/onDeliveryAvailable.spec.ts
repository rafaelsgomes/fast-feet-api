...
import { OnDeliveryAvailable } from './onDeliveryAvailable'
...
describe('On Delivery Available', () => {
  beforeEach(() => {
    ...
    new OnDeliveryAvailable(inMemoryDeliveriesRepository, sut)
  })
  it('Should send a notification when an delivery is available', async () => {
